...
namespace MSI_AEX
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (StreamWriter sw = File.CreateText("date.txt"))
            {
            ...
            do
            {
                    ...
                    for (int i = 0; i < coupleOfParents.Length; i++)
                    {
                        ...
                        for (int j = 0; j < 2; j++)
                        {
                            ...
                            else if (t >= 15 && t < 25)
                            {
                                ...
                                if (fitness[nrOfParent1] > fitness[nrOfParent2] && fitness[nrOfParent3] > fitness[nrOfParent2])
                                    coupleOfParents[i][j] = nrOfParent2;
                                else if (fitness[nrOfParent1] > fitness[nrOfParent3] && fitness[nrOfParent2] > fitness[nrOfParent3])
                            ...
                            else if (t >= 25 && t < 45)
                            {
                                ...
                                if (fitness[nrOfParent1] > fitness[nrOfParent2] && fitness[nrOfParent3] > fitness[nrOfParent2] && fitness[nrOfParent4] > fitness[nrOfParent2])
                                    coupleOfParents[i][j] = nrOfParent2;
                                else if (fitness[nrOfParent1] > fitness[nrOfParent3] && fitness[nrOfParent2] > fitness[nrOfParent3] && fitness[nrOfParent4] > fitness[nrOfParent3])
                                    coupleOfParents[i][j] = nrOfParent3;
                                else if (fitness[nrOfParent2] > fitness[nrOfParent1] && fitness[nrOfParent3] > fitness[nrOfParent1] && fitness[nrOfParent4] > fitness[nrOfParent1])
                                    coupleOfParents[i][j] = nrOfParent1;
                                else
                            ...
                            else if (t >= 45)
                            {
                                ...
                                if (fitness[nrOfParent1] > fitness[nrOfParent2] && fitness[nrOfParent3] > fitness[nrOfParent2] && fitness[nrOfParent4] > fitness[nrOfParent2] && fitness[nrOfParent5] > fitness[nrOfParent2])
                                    coupleOfParents[i][j] = nrOfParent2;
                                else if (fitness[nrOfParent1] > fitness[nrOfParent3] && fitness[nrOfParent2] > fitness[nrOfParent3] && fitness[nrOfParent4] > fitness[nrOfParent3] && fitness[nrOfParent5] > fitness[nrOfParent3])
                                    coupleOfParents[i][j] = nrOfParent3;
                                else if (fitness[nrOfParent2] > fitness[nrOfParent1] && fitness[nrOfParent3] > fitness[nrOfParent1] && fitness[nrOfParent4] > fitness[nrOfParent1] && fitness[nrOfParent5] > fitness[nrOfParent1])
                                    coupleOfParents[i][j] = nrOfParent1;
                                else if (fitness[nrOfParent2] > fitness[nrOfParent4] && fitness[nrOfParent3] > fitness[nrOfParent4] && fitness[nrOfParent1] > fitness[nrOfParent4] && fitness[nrOfParent5] > fitness[nrOfParent4])
                                    coupleOfParents[i][j] = nrOfParent4;
                                else
                ...
                //mutacja
                tempint2 = rnd.Next(10, 15);
                for (int i = 0; i < tempint2; i++)
                {
                    number = rnd.Next(0, 100);
                    tempint = rnd.Next(3, 8);
                    for (int j = 0; j < tempint; j++)
                    {
                        rndNumber = rnd.Next(0, 30);
                        if (rndNumber < 29)
                        {
                            rndsign = Populacja[number][rndNumber + 1];
                            Populacja[number][rndNumber + 1] = Populacja[number][rndNumber];
                            Populacja[number][rndNumber] = rndsign;
                            tempdouble = PopulacjaForWeight[number][rndNumber + 1];
                            PopulacjaForWeight[number][rndNumber + 1] = PopulacjaForWeight[number][rndNumber];
                            PopulacjaForWeight[number][rndNumber] = tempdouble;
                        }
                        else
                        {
                            rndsign = Populacja[number][0];
                            Populacja[number][0] = Populacja[number][rndNumber];
                            Populacja[number][rndNumber] = rndsign;
                            tempdouble = PopulacjaForWeight[number][0];
                            PopulacjaForWeight[number][0] = PopulacjaForWeight[number][rndNumber];
                            PopulacjaForWeight[number][rndNumber] = tempdouble;
                        }
                    }
                ...
                numberOfMutation++;
            } while (HistroyOfFit[t - 1] < HistroyOfFit[t - 2] ||  HistroyOfFit[t - 2] < HistroyOfFit[t - 3] || HistroyOfFit[t - 3] < HistroyOfFit[t - 4] || HistroyOfFit[t-4]<HistroyOfFit[t-5]/*  && numberOfMutation<2*/);

            //zapis do pliku ostatniej populacji
